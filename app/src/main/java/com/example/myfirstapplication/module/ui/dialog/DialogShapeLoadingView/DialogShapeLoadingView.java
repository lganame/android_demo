/*
package com.example.myfirstapplication.module.ui.dialog.DialogShapeLoadingView;
...
/*
    ...
    protected void onFinishInflate() {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.dialog_shape_loading_view, null);

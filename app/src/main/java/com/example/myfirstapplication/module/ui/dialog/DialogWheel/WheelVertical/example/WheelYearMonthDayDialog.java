/*
package com.example.myfirstapplication.module.ui.dialog.DialogWheel.WheelVertical.example;
...
import com.example.myfirstapplication.module.function.WheelHorizontal.NumericWheelAdapter;
import com.example.myfirstapplication.module.function.WheelHorizontal.OnWheelChangedListener;
import com.example.myfirstapplication.module.ui.dialog.DialogWheel.WheelVertical.DateArrayAdapter;
import com.example.myfirstapplication.module.ui.dialog.DialogWheel.WheelVertical.WheelView;
import com.example.myfirstapplication.module.ui.dialog.TransparentDialog;
import com.example.myfirstapplication.utils.VonUtil;


public class WheelYearMonthDayDialog extends TransparentDialog {
	...
	public WheelYearMonthDayDialog(Activity context) {
		super(context);
	...
	public WheelYearMonthDayDialog(Activity context,TextView tv_time) {
		super(context);
		// TODO Auto-generated constructor stub
		this.context = context;
		build();
...
/**
	...
	private void updateDays(WheelView year, WheelView month, WheelView day) {
		...
		int maxDays = VonUtil.getDaysByYearMonth(curYear-5 + year.getCurrentItem(), month.getCurrentItem()+1);
